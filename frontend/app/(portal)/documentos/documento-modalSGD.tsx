...
const DocumentoModalSGD = ({
  ...
  const urlDocumento = `${"https://sgd.regionpuno.gob.pe/sgd/files/"}${documento.urlDocumento}`;
            ...
            <div className="p-3 md:p-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <Button
                  ...
                  onClick={() =>
                    handleDownload(urlDocumento, documento.nombreBlDoc)
                  }
                >
...
export default DocumentoModalSGD;
