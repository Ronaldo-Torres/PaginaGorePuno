            ...
            {sections.map((section) => {
              ...
              return (
                <button
                  ...
                  className={`
                    relative flex items-center gap-3 px-6 py-3 rounded-xl font-medium transition-all duration-300 group cursor-pointer
                    ${isActive
                      ? 'text-[#184482] transform scale-105'
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      layoutId="activeTab"
                      className="absolute inset-0 bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl border-2 border-blue-200/50"
                      initial={false}
                  ...
                  <div className="relative z-10 flex items-center gap-3">
                    <Icon className={`h-5 w-5 transition-colors duration-300 ${isActive ? 'text-[#184482]' : 'text-gray-500 group-hover:text-[#184482]'
                      }`} />
                  ...
                  {isActive && (
                    <motion.div
                      className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-8 h-1 bg-gradient-to-r from-[#184482] to-blue-400 rounded-full"
