...
const FolderItem = ({
  ...
  const fetchDocumentos = async () => {
    ...
    setLoading(true);
    try {
      // Usar servicio local para normativos
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-sm">
                      {searchTerm ?
                        ...
                        "No hay documentos normativos disponibles en esta carpeta"
                      }
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="p-8">
                <div className="flex flex-col items-center space-y-4 text-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Esta carpeta no contiene documentos de gestion
                    </p>
                  </div>
                </div>
              </CardContent>
...
export default function Normativos() {
  ...
  const getTiposDocumento = async () => {
    const response = await TipoDocumentoService.getTiposDocumento("B");
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            <h1 className="text-3xl font-bold tracking-tight">Documentos Normativos</h1>
        ...
        <Alert>
          ...
          <AlertDescription>
            Documentos de gestion exclusivamente del sistema local del Gobierno Regional
          </AlertDescription>
        </Alert>
      </div>
