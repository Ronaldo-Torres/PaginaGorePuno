...
const FolderItem = ({
    ...
    const fetchDocumentos = async () => {
        ...
        try {
            ...
            //     "tipoFiltro:", filterType === "all" ? "" : filterType
            // );

            // Usar servicio local para transparencia
            ...
            console.log("respondeasdasadas: ", response)
                        ...
                        <CardContent className="p-4">
                            <div className="space-y-4">
                                <div className="relative">
                                    ...
                                    <Input
                                        type="text"
                                        placeholder="Buscar documentos transparencia..."
                                        value={searchTerm}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-muted-foreground text-sm">
                                            {searchTerm ?
                                                ...
                                                "No hay documentos transparencia disponibles en esta carpeta"
                                            }
                                        </p>
                                    </div>
                                </div>
                            ...
                            <CardContent className="p-8">
                                <div className="flex flex-col items-center space-y-4 text-center">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-muted-foreground text-sm">
                                            Esta carpeta no contiene documentos transparencia
                                        </p>
                                    </div>
                                </div>
                            </CardContent>
...
export default function transparencia() {
    ...
    const getTiposDocumento = async () => {
        const response = await TipoDocumentoService.getTiposDocumento("D");
            ...
            <div className="space-y-4">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        <h1 className="text-3xl font-bold tracking-tight">Documentos transparencia</h1>
                        <p className="text-muted-foreground text-lg">
                            Ordenanzas, acuerdos y resoluciones normativas del Gobierno Regional
                        </p>
                    </div>
                </div>
                ...
                <Alert>
                    ...
                    <AlertDescription>
                        Documentos transparencia exclusivamente del sistema local del Gobierno Regional
                    </AlertDescription>
                </Alert>
            </div>
